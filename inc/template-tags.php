 ...
 */
function happyprime_using_amp_live_list_comments() {
 ...
 */
function happyprime_add_amp_live_list_pagination_attribute( $markup ) {
 ...
 */
function happyprime_index_header() {
 ...
 */
function happyprime_post_categories() {
 ...
 */
function happyprime_comments_link() {
 ...
 */
function happyprime_edit_post_link() {
	edit_post_link(
		sprintf(
			wp_kses(
 ...
 */
function happyprime_post_thumbnail() {
 ...
 */
function happyprime_attachment_in( $post ) {
	if ( ! empty( $post->post_parent ) ) :
		$postlink = sprintf(
			/* translators: %s: original post where attachment was added. */
			esc_html_x( 'in %s', 'original post', 'happyprime' ),
 ...
 */
function happyprime_the_attachment_navigation() {
	?>
	<nav class="navigation post-navigation" role="navigation">
		<h2 class="screen-reader-text"><?php echo esc_html__( 'Post navigation', 'happyprime' ); ?></h2>
		<div class="nav-links">
			<div class="nav-previous">
				<div class="post-navigation-sub">
					<?php echo esc_html__( 'Previous attachment:', 'happyprime' ); ?>
				</div>
				<?php previous_image_link( false ); ?>
			</div><!-- .nav-previous -->
			<div class="nav-next">
				<div class="post-navigation-sub">
					<?php echo esc_html__( 'Next attachment:', 'happyprime' ); ?>
				</div>
